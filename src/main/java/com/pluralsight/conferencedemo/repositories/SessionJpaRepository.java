...
@RepositoryRestResource(
        ...
        collectionResourceRel = "conference_speakers",
        excerptProjection = SessionDetailView.class // only works with collection resources (i.e. the default endpoint, not specific item/index)
)
